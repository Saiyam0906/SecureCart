...
import com.example.SecureCart.Exception.OrderItemNotFound;
import com.example.SecureCart.Exception.UnauthorizedAccessException;
import com.example.SecureCart.Interface.OrderItemInterface;
import com.example.SecureCart.Mapper.OrderItemMapper;
import com.example.SecureCart.Repository.OrderItemRepository;
import com.example.SecureCart.Repository.OrderRepository;
	...
	private final OrderRepository orderRepository;
	 ...
	 @Override
	    ...
	    public List<OrderItemDto> getOrderItemsByStatus(String status) {
	        List<OrderItem> items = orderItemRepository.findByOrderOrderStatus(status);
	        return orderItemMapper.toDTOList(items);
	    }
